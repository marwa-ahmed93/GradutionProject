...
<h6 class="m-3">Employee / Edit / {{ $users->name }}</h6>
<a type="button" class="btn btn-primary m-3" href="{{ route('employee.view') }}">Back</a>
...
<input type="hidden" name="id" value="{{ $users->id }}">
 ...
 <label class="mt-2">User_id</label>
    <input type="number" name="user_id" class="form-control" value="{{ $users->employee->user_id }}" >
  

   <label class="mt-2">Edu-email</label>
    <input type="email" name="user_id" class="form-control" value="{{ $users->employee->eduEmail }}" >
  

   <label class="mt-2">Salary</label>
    <input type="number" name="user_id" class="form-control" value="{{ $users->employee->salary}}" >
