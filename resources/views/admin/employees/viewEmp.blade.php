...
<a class="btn btn-sm btn-primary mb-4" href="{{ route('register.form') }}">{{ __('Add_employee') }}</a>
            ...
            <table id="employeeList"  class=" table  m-4 py-5 ">
                ...
                <tbody id="tableBody">
                   ...
                   @foreach($users as $user)
                     ...
                     <td>{{ $user->employee->eduEmail}}</td>
                     <td>{{ $user->employee->grade}}</td>
                      
                    
                  <td>
                     <a class="btn btn-sm btn-warning" href="{{ route('edit.employee' , $user->id) }}">Edit</a>
                     <a class="btn btn-sm btn-danger" href="{{ route('delete.employee' , $user->id) }}">Delete</a>
                     </td>
