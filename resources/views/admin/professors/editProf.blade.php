...
<h6 class="m-3">Professor / Edit / {{ $users->name }}</h6>
<a type="button" class="btn btn-primary m-3" href="{{ route('professor.view') }}">Back</a>

</div>
<div class="container m-5"> 
@include('front.inc.errors')
<form method="post" action="{{route('update.professor')}}">
@csrf
<input type="hidden" name="id" value="{{ $users->id }}">
 ...
 <label class="mt-2">User_id</label>
    <input type="number" name="user_id" class="form-control" value="{{ $users->professor->user_id }}" >
  

   <label class="mt-2">Edu-email</label>
    <input type="email" name="user_id" class="form-control" value="{{ $users->professor->eduEmail }}" >
  

   <label class="mt-2">Salary</label>
    <input type="number" name="user_id" class="form-control" value="{{ $users->professor->salary}}" >
