                ...
                <tbody id="tableBody">
                   ...
                   @foreach($id_cards as $id_card)
                     ...
                     <th scope="row">{{ $loop->iteration }}</th>
                      <td>{{ $id_card->name }}</td>
                     <td>{{ $id_card->department  }}</td>
                     <td>{{ $id_card->grade}}</td>
                     <td>{{ $id_card->university_code}}</td>
                     <td>{{ $id_card->academic_year }}</td>
                     <td>  
                      <img class="img-fluid rounded-circle" src="{{asset($id_card->img) }}" height="50px" width="100"wialt="">
                   </td>
                    
                    
                  <td>
                     <a class="btn btn-sm btn-danger" href="{{ route('delete.idRequest',$id_card->id)}}">Delete </a>
