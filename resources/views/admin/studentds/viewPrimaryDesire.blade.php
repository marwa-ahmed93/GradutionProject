            ...
            <table id="employeeList"  class= "table  m-4 py-5 ">
              <thead>
                ...
                <div id="rimary_desiers" class="row">
                    @foreach($primary_desiers as $primary_desier)
                     
                  <tr>
                     <th scope="row">{{ $loop->iteration }}</th>
                     <td>{{ $primary_desier->name }}</td>
                     <td>{{ $primary_desier->national_id }}</td>
                     <td>{{ $primary_desier->seat_number}}</td>
                     <td>{{ $primary_desier->first_desire}}</td>
                     <td>{{ $primary_desier->second_desire}}</td>
                     <td>{{ $primary_desier->third_desire}}</td>
                     <td>{{ $primary_desier->fourth_desire}}</td>
                     <td>
                     <a class="btn btn-sm btn-danger" href="{{ route('delete.desire' , $primary_desier->id) }}">Delete</a>
                       </td>
