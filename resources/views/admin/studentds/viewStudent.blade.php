                  ...
                  <li>
                    ...
                    <ul class="dropdown-menu dropdown-submenu dropdown-submenu-left">
                      ...
                      <li>
                        ...
                        <ul class="dropdown-menu dropdown-submenu dropdown-submenu-left">
                            <li>
                              <a class="dropdown-item" href="{{ route('schedulesView')}}">Upload</a>
                            </li>
                            <li>
        ...
        <div  class="container">
            <table id="employeeList"  class= "table  m-4 py-5 ">
                ...
                <tbody id="tableBody">
                  ...
                  <td>
                     <a class="btn btn-sm btn-warning" href="{{ route('edit.student' , $user->id) }}">Edit</a>
                     <a class="btn btn-sm btn-danger" href="{{ route('delete.student' , $user->id) }}">Delete</a>
                     </td>
