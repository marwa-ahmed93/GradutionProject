...
<head>
    ...
    <title>  طلب الحصول علي شهادة تدرج (خمس سنوات) باللغة العربية  </title>    
    ...
    <div class= "container  py-5  w-75 my-5">
        <div class="row">
            <div class="col-md-10  m-auto">
                <h1 class="text-center">   بيانات طلب الحصول علي شهادة تدرج باللغة العربية </h1>
                  ...
                  <div class="form-group row">
                    ...
                    <!-- <div  class="col-md-6  ">
                        <div class="form-group  ">
                          ...
                          <input id="projectNameInE" class="form-control" type= "text"  >
                        </div>
                      </div>
                  </div> -->
