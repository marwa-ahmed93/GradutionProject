...
<head>
    ...
    <title>  طلب الحصول علي شهادة تدرج (خمس سنوات) باللغة الانجليزية  </title>    
    ...
    <div class= "container  py-5  w-75 my-5">
        <div class="row">
            <div class="col-md-10  m-auto">
                <h1 class="text-center">   بيانات طلب الحصول علي شهادة تدرج باللغة الانجليزية </h1>
                  ...
                  <div class="form-group row">
                    ...
                    <div  class="col-md-6  ">
                        <div class="form-group  ">
                          ...
                          <input id="nameInE" name="nameInE"class="form-control" type= "text"  >
                        </div>
                      </div>
                  </div>
                       ...
                       <div class="form-group row ">
                        ...
                        <div  class="col-md-3">
                          <div class="form-group " >
                            <label>  الشعبة </label>
                           <select id="grade" name="gradeD"  class="form-control" >
                    ...
                    <div class="form-group row">
                        <div class="form-group col-md-4"   >
                            <label> هل قام الخريج بتغيير اسمه اثناء او بعد الدراسة ؟</label>
                        </div>
                      
                        <div class="form-group col-md-2"   >
                            <input type="radio" id="yesChangeName" name="changeNameOrNot" value="yes">
                            <label class="mr-1" > نعم  </label>
                        </div>
                        <div class="form-group col-md-2"   >
                            <input type="radio" id="noChangeName" name="changeNameOrNot" value="no" >
                    ...
                    <div class="row file">
                        <div class=" form-group col-md-4">
                            ...
                            <input class="form-control" type="file" id="image_input" accept=".png,.jpeg,.jpg " name="img_PreviousCertificateFile">
                        ...
                        <div class=" form-group col-md-4">
                            ...
                            <input required="" class="form-control" type="file" id="image_input2" accept=".png,.jpeg,.jpg" data-val="true" data-val-required="The NationalIdFile field is required." name="img_NationalIdFile">
                         ...
                         <div class="form-group   col-md-4  ">
                            ...
                            <input class="form-control" type="file" id="image_input5" accept=".png,.jpeg,.jpg" name="img_PaymentReceipt">
                           <span class="text-danger field-validation-valid" data-valmsg-for="PaymentReceipt" data-valmsg-replace="true"></span>
